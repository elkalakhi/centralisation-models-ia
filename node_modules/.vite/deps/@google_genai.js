...
function generateContentConfigToMldev$1(apiClient, fromObject, parentObject) {
	...
	if (fromImageConfig != null) setValueByPath(toObject, ["imageConfig"], fromImageConfig);
	return toObject;
}
...
var LIBRARY_LABEL = `google-genai-sdk/1.29.0`;
				...
				while (remoteCallCount < maxRemoteCalls) {
					...
					try {
						for (var _f = true, response_1 = (e_1 = void 0, __asyncValues(response)), response_1_1; response_1_1 = yield __await(response_1.next()), _c$1 = response_1_1.done, !_c$1; _f = true) {
							...
							const chunk = _e;
							yield yield __await(chunk);
							if (chunk.candidates && ((_a$1 = chunk.candidates[0]) === null || _a$1 === void 0 ? void 0 : _a$1.content)) {
	...
	async generateContentStreamInternal(params) {
		...
		if (this.apiClient.isVertexAI()) {
			...
			return response.then(function(apiResponse) {
				return __asyncGenerator(this, arguments, function* () {
					var _a$1, e_2, _b$1, _c$1;
					try {
						for (var _d$1 = true, apiResponse_1 = __asyncValues(apiResponse), apiResponse_1_1; apiResponse_1_1 = yield __await(apiResponse_1.next()), _a$1 = apiResponse_1_1.done, !_a$1; _d$1 = true) {
						...
						try {
							if (!_d$1 && !_a$1 && (_b$1 = apiResponse_1.return)) yield __await(_b$1.call(apiResponse_1));
						} finally {
			...
			return response.then(function(apiResponse) {
				return __asyncGenerator(this, arguments, function* () {
					var _a$1, e_3, _b$1, _c$1;
					try {
						for (var _d$1 = true, apiResponse_2 = __asyncValues(apiResponse), apiResponse_2_1; apiResponse_2_1 = yield __await(apiResponse_2.next()), _a$1 = apiResponse_2_1.done, !_a$1; _d$1 = true) {
						...
						try {
							if (!_d$1 && !_a$1 && (_b$1 = apiResponse_2.return)) yield __await(_b$1.call(apiResponse_2));
						} finally {
